...
var Range = function (_React$Component) {
  ...
  Range.prototype.render = function render() {
    ...
    if (showExtraTracks) {
      tracks.unshift(_react2['default'].createElement(_Track2['default'], {
        className: (0, _classnames2['default'])(prefixCls + '-track', prefixCls + '-track-start'),
        vertical: vertical,
        included: included,
        offset: 0,
        length: offsets[0],
      ...
      tracks.push(_react2['default'].createElement(_Track2['default'], {
        className: (0, _classnames2['default'])(prefixCls + '-track', prefixCls + '-track-end'),
        vertical: vertical,
        included: included,
